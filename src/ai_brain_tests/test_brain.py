...
class TestBrain(unittest.TestCase):
    ...
    def test_get_default_brain_name(self):
        brain = Brain.get_default_brain(brains_index_file=TEST_DATA_DIR)
        brain_path = brain.get_parameters()["path"]
        self.assertEqual(brain_path, "mathematics")

    def test_get_default_brain_name_without_default(self):
        brain = Brain.get_default_brain(brains_index_file=TEST_DATA_DIR, brain_index_filename="brains_with_no_default.json")
        brain_path = brain.get_parameters()["path"]
