...
class TestChunk(unittest.TestCase):
    ...
    def test_chunk_as_str(self):
        doc_id = str(uuid.uuid4())
        original_document_id = str(uuid.uuid4())
        chunk1 = Chunk(title="apple", content="Apple are red",
                      uri="some_uri", id=doc_id, original_document_id=original_document_id)
        chunk2 = Chunk(title="banana", content="Bananas are krumm",
                       uri="some_uri", id=doc_id, original_document_id=original_document_id)
        chunk3 = Chunk(title="orange", content="Oranges are round",
                       uri="some_uri", id=doc_id, original_document_id=original_document_id)
        ...
        self.assertEqual(
            context, "Apple are red--Bananas are krumm--Oranges are round")
