...
def get_models() -> List[Model]:
    ...
    for model in models_as_json:
        description = (
            f"Family: {model['details']['family']}, Size:"
...
def extract_inner_working(
    ollama_response: Dict[str, Union[str, int]],
) -> Dict[str, Union[str, int]]:
    ollama_fields_to_report = [
        "model",
        "total_duration",
        "prompt_eval_count",
        "eval_count",
