...
class TestPromptLib(unittest.TestCase):
    ...
    def test_get_prompt_template(self):
        ...
        self.assertIsInstance(
            prompt_template, str, "Prompt Templates should be a string"
        )

    def test_get_prompt(self):
        prompt_fields = {
            "documents": """
Marie Curie (1867-1934) was a Polish and naturalised-French physicist
and chemist who conducted pioneering research on radioactivity. Born in
Warsaw, she studied in Poland until she was 24, when she moved to Paris to
earn her higher degrees.
  """,
