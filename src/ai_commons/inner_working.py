...
def add_inner_working(
    ...
    # # If the additional inner working has a list of inner workings, we need to add them to the new inner working
    # if hasattr(new_inner_working[titel], "inner_working"):
    #     new_inner_working[titel] = new_inner_working[titel] + additional_inner_working["inner_working"]
